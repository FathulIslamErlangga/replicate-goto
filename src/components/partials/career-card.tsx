  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col items-center justify-center gap-2 px-5'>
        <h3 className='font-MaisonNeueDemi md:font-MaisonNeueBold pb-5 w-[100%] text-center text-lg lg:text-2xl'>
          {title}
        </h3>
        <p className='font-MaisonNeueBook  leading-tight xl:text-lg'>
          {description}
        </p>
      </div>
    </div>
